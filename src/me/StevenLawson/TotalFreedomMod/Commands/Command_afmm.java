...
public class Command_afmm extends TFM_Command
{
    @Override
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        playerMsg("AlexFreedomMod for 'Alex Freedom'", ChatColor.GOLD);
        ...
        playerMsg("AFM Addition created by _herobrian35_", ChatColor.GOLD);
