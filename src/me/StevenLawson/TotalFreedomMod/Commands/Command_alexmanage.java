    ...
    public boolean run(final CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        else if (args.length == 2)
        {
            ...
            else if (args[0].equalsIgnoreCase("test"))
            {
                if (args[1].equals("on"))
                {
                    TFM_Util.adminAction(ChatColor.RED + "[Alert]: " + sender.getName(), "Is doing something...", false);
                }

                else if (args[1].equals("off"))
                {
                    TFM_Util.adminAction(ChatColor.RED + "[Alert]: " + sender.getName(), "has succesfully ended doing something on the server", false);
                }
