...
@CommandParameters(description = "Allows senior Administrators to super them self..", usage = "/<command> [reload]")
public class Command_rcon extends TFM_Command
{
    @Override
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        if (args.length == 1)
        {
            ...
            sender_p.sendMessage(ChatColor.RED + "You have supered your self. ");
