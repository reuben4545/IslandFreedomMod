...
public class Command_superdoom extends TFM_Command
{
    ...
    public boolean run(final CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
          ...
          if (!sender.getName().equalsIgnoreCase("Alex33856"))
        {
            ...
            TFM_Util.adminAction("[Risk]: " + sender.getName(), "You're now at risk of suspension from PiggoWink. :/", true);
            sender.setOp(false);
            return true;
        } 
        if (args.length == 0)
        ...
        TFM_Util.bcastMsg(player.getName() + "Fuck with piggo bout a week ago.. Fuck with us and we tweaking whoe tweaking whoe!", ChatColor.RED);
        ...
        new BukkitRunnable()
        {
            ...
            public void run()
            {
                ...
                // kick player
                player.kickPlayer(ChatColor.RED + "Bith messed with me...bout week agooo... Fuck with Piggo and we tweeking whoe tweeking whoe");
            }
